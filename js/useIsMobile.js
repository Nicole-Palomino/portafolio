...
const translations = {
    en: {
        ...
        "about.p1": "I'm a web developer focused on creating digital experiences that combine modern technology, clean design and well-structured data. I work on both backend and frontend, using tools like FastAPI, React, PHP, Python and JavaScript, with a focus on performance, usability and scalability. I am passionate about turning complex ideas into simple, functional solutions that deliver real value.",
        "about.p2": "Currently I have created DevFut, a platform that transforms soccer statistics into interactive and useful visualizations for fans and analysts. This project reflects my vision: to build applications that inform, connect and motivate to explore beyond the superficial. I define myself by my constant curiosity, attention to detail and commitment to learning and continuous improvement.",
        "about.name": "Name:",
        "about.email": "Email:",
        ...
        // Data Analysis
        "dataAnalysis.title": "Data Insights",
        "dataAnalysis.subtitle": "Data Analysis & Visualization",
        "dataAnalysis.description": "Transforming complex data into meaningful insights through advanced analytics and beautiful visualizations.",
        "dataAnalysis.charts": "Interactive Charts",
        "dataAnalysis.caseStudies": "Case Studies",
        "dataAnalysis.monthlyGrowth": "Monthly Growth Trends",
        "dataAnalysis.categoryDistribution": "Category Distribution",
        "dataAnalysis.marketSegmentation": "Market Segmentation",
        "dataAnalysis.annualPerformance": "Annual Performance",
        "dataAnalysis.ecommerce.title": "E-commerce Optimization",
        "dataAnalysis.ecommerce.description": "Increased conversion rates by 35% through data-driven UX improvements and personalized recommendations.",
        "dataAnalysis.ecommerce.list1": "Customer segmentation analysis",
        "dataAnalysis.ecommerce.list2": "A/B testing of UI elements",
        "dataAnalysis.ecommerce.list3": "Purchase pattern prediction",
        "dataAnalysis.ecommerce.list4": "Inventory optimization",
        "dataAnalysis.financial.title": "Financial Forecasting",
        "dataAnalysis.financial.description": "Developed predictive models with 92% accuracy for stock price movements based on market indicators.",
        "dataAnalysis.financial.list1": "Time series analysis",
        "dataAnalysis.financial.list2": "Sentiment analysis of news",
        "dataAnalysis.financial.list3": "Market volatility prediction",
        "dataAnalysis.financial.list4": "Risk assessment modeling",
        "dataAnalysis.healthcare.title": "Healthcare Analytics",
        "dataAnalysis.healthcare.description": "Reduced patient readmission rates by 28% through predictive analytics and care optimization.",
        "dataAnalysis.healthcare.list1": "Patient outcome prediction",
        "dataAnalysis.healthcare.list2": "Treatment effectiveness analysis",
        "dataAnalysis.healthcare.list3": "Resource allocation optimization",
        "dataAnalysis.healthcare.list4": "Early intervention modeling",
    ...
    es: {
        ...
        "about.p1": "Soy un desarrollador web enfocado en crear experiencias digitales que combinan tecnología moderna, diseño limpio y datos bien estructurados. Trabajo tanto en el backend como en el frontend, utilizando herramientas como FastAPI, React, PHP,  Python y JavaScript, con un enfoque en rendimiento, usabilidad y escalabilidad. Me apasiona convertir ideas complejas en soluciones simples y funcionales que aporten valor real.",
        "about.p2": "Actualmente he creado DevFut, una plataforma que transforma estadísticas de fútbol en visualizaciones interactivas y útiles para los fans y analistas. Este proyecto refleja mi visión: construir aplicaciones que informen, conecten y motiven a explorar más allá de lo superficial. Me defino por mi curiosidad constante, atención al detalle y compromiso con el aprendizaje y la mejora continua.",
        "about.name": "Nombre:",
        "about.email": "Correo:",
        ...
        // Data Analysis
        "dataAnalysis.title": "Información de Datos",
        "dataAnalysis.subtitle": "Análisis y Visualización de Datos",
        "dataAnalysis.description": "Transformando datos complejos en información significativa a través de análisis avanzados y hermosas visualizaciones.",
        "dataAnalysis.charts": "Gráficos Interactivos",
        "dataAnalysis.caseStudies": "Casos de Estudio",
        "dataAnalysis.monthlyGrowth": "Tendencias de Crecimiento Mensual",
        "dataAnalysis.categoryDistribution": "Distribución por Categoría",
        "dataAnalysis.marketSegmentation": "Segmentación de Mercado",
        "dataAnalysis.annualPerformance": "Rendimiento Anual",
        "dataAnalysis.ecommerce.title": "Optimización de E-commerce",
        "dataAnalysis.ecommerce.description": "Aumento de tasas de conversión en un 35% mediante mejoras de UX basadas en datos y recomendaciones personalizadas.",
        "dataAnalysis.ecommerce.list1": "Análisis de segmentación de clientes",
        "dataAnalysis.ecommerce.list2": "Pruebas A/B de elementos de UI",
        "dataAnalysis.ecommerce.list3": "Predicción de patrones de compra",
        "dataAnalysis.ecommerce.list4": "Optimización de inventario",
        "dataAnalysis.financial.title": "Pronóstico Financiero",
        "dataAnalysis.financial.description": "Desarrollo de modelos predictivos con 92% de precisión para movimientos de precios de acciones basados en indicadores de mercado.",
        "dataAnalysis.financial.list1": "Análisis de series temporales",
        "dataAnalysis.financial.list2": "Análisis de sentimiento de noticias",
        "dataAnalysis.financial.list3": "Predicción de volatilidad del mercado",
        "dataAnalysis.financial.list4": "Modelado de evaluación de riesgos",
        "dataAnalysis.healthcare.title": "Analítica de Salud",
        "dataAnalysis.healthcare.description": "Reducción de tasas de readmisión de pacientes en un 28% mediante análisis predictivo y optimización de cuidados.",
        "dataAnalysis.healthcare.list1": "Predicción de resultados de pacientes",
        "dataAnalysis.healthcare.list2": "Análisis de efectividad de tratamientos",
        "dataAnalysis.healthcare.list3": "Optimización de asignación de recursos",
        "dataAnalysis.healthcare.list4": "Modelado de intervención temprana",
